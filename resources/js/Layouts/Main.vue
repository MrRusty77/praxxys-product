<template lang="">
    <div class="block w-full h-screen overscroll-none">
        ...
        <div class="flex w-full h-12 p-2 text-white bg-gray-800 header-not-sr-only">
            ...
            <div class="w-7/12">
                <div class="flex w-6/12 mx-auto bg-white rounded hover:ring-2 hover:ring-blue-500 focus:ring-2 focus:ring-blue-500" v-show="searchInput">                
        ...
        <el-drawer v-model="drawer" title="I am the title" size="18%" :with-header="false" :custom-class="side_menu" :direction="direction">
            ...
            <div class="px-3 py-2 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800">
                ...
                <ul class="p-1 space-y-2">
                    ...
                    <li>
                        <router-link  to="/videos" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            <video-icon class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
